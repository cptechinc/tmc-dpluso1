...
<?php if ($input->get->text('frombin')) : ?>
	<?php if (!$whseconfig->validate_bin($input->get->text('frombin'))) : ?>
		<div class="alert alert-danger" role="alert">
			<strong>Error! </strong> <?= $input->get->text('frombin'); ?> is not a valid bin
		</div>
	<?php endif; ?>
<?php endif; ?>
<form action="<?= $page->url; ?>" method="get" class="select-bin-form allow-enterkey-submit">
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="text" class="form-control" id="frombin" name="frombin">
            <span class="input-group-btn">
                <button type="button" class="btn btn-default show-possible-bins" data-input="frombin"> <span class="fa fa-search" aria-hidden="true"></span> </button>
            </span>
        </div>
    </div>
