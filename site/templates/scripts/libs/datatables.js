 ...
 *   https://datatables.net/download/#bs/dt-1.10.18/b-1.5.2/b-colvis-1.5.2/b-print-1.5.2/cr-1.5.0/fh-3.1.4/rr-1.2.4/sc-1.5.0
 *
 * Included libraries:
 *   DataTables 1.10.18, Buttons 1.5.2, Column visibility 1.5.2, Print view 1.5.2, ColReorder 1.5.0, FixedHeader 3.1.4, RowReorder 1.2.4, Scroller 1.5.0
 */
...
(function(h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs/dt-1.10.18/b-1.5.2/b-colvis-1.5.2/b-print-1.5.2/cr-1.5.0/fh-3.1.4/rr-1.2.4/sc-1.5.0",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
(function(b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'text-center'i><'text-center'p>>",
        renderer: "bootstrap"
    });
